...
import me.noci.oitc.listener.endingphase.EndAsyncPlayerChatListener;
...
import me.noci.oitc.listener.lobbyphase.LobbyAsyncPlayerChatListener;
...
public class OITC extends JavaPlugin {
    ...
    private void registerListeners() {
        ...
        registerListener(new LobbyAsyncPlayerChatListener(this, stateManager, game));
        registerListener(new GamePlayerDamageByPlayerListener(this, stateManager, game));
        registerListener(new GameAsyncPlayerChatListener(this, stateManager, game));
        ...
        registerListener(new EndAsyncPlayerChatListener(this, stateManager, game));
